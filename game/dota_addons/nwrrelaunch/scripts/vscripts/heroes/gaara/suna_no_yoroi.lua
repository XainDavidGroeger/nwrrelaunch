...
function gaara_suna_no_yoroi:OnToggle()
	...
	if self:GetToggleState() then
		...
		ParticleManager:CreateParticle("particles/units/heroes/gaara/armor/gaara_mana_shield_cast.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
		...
		ParticleManager:CreateParticle("particles/units/heroes/gaara/armor/gaara_mana_shield_end.vpcf", PATTACH_ABSORIGIN_FOLLOW, self:GetCaster())
