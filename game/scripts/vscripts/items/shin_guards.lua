...
================================================================================================================= ]]
function modifier_item_shin_guards_datadriven_on_created(keys)
	if not keys.caster:IsRangedAttacker() then
		keys.ability:ApplyDataDrivenModifier(keys.caster, keys.caster, "modifier_item_shin_guards_block", {duration = -1})
	else 
		keys.ability:ApplyDataDrivenModifier(keys.caster, keys.caster, "modifier_item_shin_guards_block_range", {duration = -1})
	end
end
